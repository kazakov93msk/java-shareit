...
import static ru.practicum.shareit.utility.RequestUtil.FROM_SIZE_PATH;
...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> findAllByBooker(Long userId, BookingState state, Long from, Integer size) {
        Map<String, Object> params = Map.of(
                "state", state,
                "from", from,
                "size", size
        );
        return get("?state={state}&" + FROM_SIZE_PATH, userId, params);
    }
    ...
    public ResponseEntity<Object> findAllByItemsOwner(Long userId, BookingState state, Long from, Integer size) {
        ...
        return get("/owner?state={state}&" + FROM_SIZE_PATH, userId, params);
    }
